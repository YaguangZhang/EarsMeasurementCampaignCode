...
%FITALPHABETAWITHGIVENGAMMA Fit the input distances and the cooresponding path losses with
%the Alpha/Beta/Gamma model model with a custom fixed gamma for a specified frequence.
%
