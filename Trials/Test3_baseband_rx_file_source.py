...
class Test3_baseband_rx_file_source(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Test3 Baseband Rx File Source")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Test3 Baseband Rx File Source")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Test3_baseband_rx_file_source")
...
def main(top_block_cls=Test3_baseband_rx_file_source, options=None):
