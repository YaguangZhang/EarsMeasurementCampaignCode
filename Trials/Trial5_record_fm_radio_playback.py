...
class Trial5_record_fm_radio_playback(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Trial5_record_fm_radio_playback")
        ...
        self.blocks_file_meta_source_0 = blocks.file_meta_source('C:\\Users\\Zyglabs\\Dropbox\\2017_05_Summer_Research\\1_EARS\\EarsMeasurementCampaignCode\\Trials\\Trial5_record_fm_radio.out', True, False, '')
...
def main(top_block_cls=Trial5_record_fm_radio_playback, options=None):
