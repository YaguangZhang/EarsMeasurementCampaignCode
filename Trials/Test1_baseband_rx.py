...
# Title: Test1 Baseband Rx
# Generated: Mon Jun 12 16:18:47 2017
##################################################
...
class Test1_baseband_rx(gr.top_block, Qt.QWidget):
...
def main(top_block_cls=Test1_baseband_rx, options=None):
