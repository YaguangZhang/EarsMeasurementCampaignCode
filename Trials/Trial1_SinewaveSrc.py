...
# Title: Trial1 Sinewavesrc
# Generated: Thu Jun  8 00:34:34 2017
##################################################
...
class Trial1_SinewaveSrc(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'C:\\Users\\Zyglabs\\Dropbox\\2017_05_Summer_Research\\EARS\\Refs\\GnuRadio\\Trials\\Trial1_SinewaveSrc.out', False)
    ...
    def get_src_freq(self):
        return self.src_freq

    def set_src_freq(self, src_freq):
        self.src_freq = src_freq
        self.analog_sig_source_x_0.set_frequency(self.src_freq)
...
def main(top_block_cls=Trial1_SinewaveSrc, options=None):
