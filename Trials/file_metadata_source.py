...
# Generated: Thu Jun  8 11:20:25 2017
##################################################
...
class file_metadata_source(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_tag_debug_0 = blocks.tag_debug(gr.sizeof_gr_complex*1, 'Test', ""); self.blocks_tag_debug_0.set_display(True)
        self.blocks_file_meta_source_0 = blocks.file_meta_source('C:\\Users\\Zyglabs\\Dropbox\\2017_05_Summer_Research\\EARS\\Refs\\GnuRadio\\Trials\\Trail2_file_metadata_sink.out', False, True, '')
...
def main(top_block_cls=file_metadata_source, options=None):
